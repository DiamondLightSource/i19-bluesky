...
@patch(
    "i19_bluesky.serial.example_zebra_plans.zebra_collection_setup_plan.setup_zebra_for_triggering"
)
@patch(
    "i19_bluesky.serial.example_zebra_plans.zebra_collection_setup_plan.setup_out_triggers"
)

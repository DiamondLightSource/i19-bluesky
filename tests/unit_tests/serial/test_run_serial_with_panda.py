...
@patch("i19_bluesky.serial.run_serial_with_panda.reset_panda")
@patch("i19_bluesky.serial.run_serial_with_panda.bps.sleep")
@patch("i19_bluesky.serial.run_serial_with_panda.disarm_panda")
@patch("i19_bluesky.serial.run_serial_with_panda.arm_panda")
@patch("i19_bluesky.serial.run_serial_with_panda.setup_panda_for_rotation")
